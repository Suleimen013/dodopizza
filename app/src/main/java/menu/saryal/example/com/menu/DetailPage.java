...
public class DetailPage extends ActionBarActivity {
    ...
    public void displayData() {
        ...
        menu_cost_view.setText("Cost Per Plate:  " + menu_cost_string+ "тг");
    ...
    public void displayUpdate() {
        ...
        total_cost_view.setText("Total Cost:  " + new DecimalFormat("#.##").format(toal_cost_double)+"тг");
